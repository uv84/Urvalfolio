...
export const PROJECTS: Project[] = [
  {
    ...
    link: "https://wealth-ai-seven.vercel.app/",
    skills: [
      "Next.js",
      "React",
      "Shadcn UI",
    ...
    description: `
– Built a full-stack AI finance platform using Next.js, Supabase, Tailwind, Prisma, Inngest, ArcJet, and Shadcn UI to
track income and expenses across multiple accounts.

– Integrated Gemini AI for extracting bill data and automated emails for budget alerts and monthly financial
summaries`,
...

  {
    ...
    link: "https://therapistai-kohl.vercel.app/",
    skills: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    description: `
– Built a full-stack AI therapy platform using Next.js, Express, Node.js, Tailwind CSS, MongoDB, Inngest, and
Shadcn UI to track user moods and provide personalized therapy recommendations.

– Integrated Gemini AI for therapy suggestions, interactive chat sessions, breathing exercises with visual guidance,
and a digital Zen garden feature for stress relief.
`,
